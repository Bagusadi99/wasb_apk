                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButtonIcon">
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('export_excel', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'koridor' => request('koridor')]) }}">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-end">
                        <a href="{{ route('export_excel', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'koridor' => request('koridor')]) }}"
