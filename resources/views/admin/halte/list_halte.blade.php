...
<body style="background-color: #d5edd2;">
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3 style="color: #4A8939">Halte</h3>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex">
                                    ...
                                    <h4 class="card-title">List Halte</h4>
                                </div>
                                                ...
                                                @foreach ($halte as $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            onclick="openEditModal('{{ $item->id }}', '{{ $item->halte_nama }}', '{{ $item->koridor ? $item->koridor->koridor_nama : '' }}')">
    ...
    <script>
        function openEditModal(id, halteNama, koridorNama) {
            document.getElementById('edit_halte_nama').value = halteNama;
