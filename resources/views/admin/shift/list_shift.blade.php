...
<body style="background-color: #d5edd2;">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex">
                                    ...
                                    <h4 class="card-title">List Shift</h4>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-danger mb-1 mt-1" data-bs-toggle="modal" data-bs-target="#deleteModal" 
                                                                onclick="setDeleteData('{{ $item->shift_id }}', '{{ $item->shift_nama}}')">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                @csrf
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" name="shift_nama" class="form-control" placeholder="Nama Shift">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                <form id="deleteForm" action="" method="POST">
                                                    ...
                                                    @method('DELETE')
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="deleteModalLabel">Hapus Shift</h5>
                                                        <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
                                                            <i data-feather="x"></i>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>Apakah Anda yakin ingin menghapus shift - <br>
                                                            <strong id="delete_shift_nama"></strong>?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Batal</button>
    ...
    <script>
        function loadDataShift(id, shiftNama) {
        ...
        function setDeleteData(id, shiftNama) {
            // Isi data ke dalam modal hapus
            document.getElementById('delete_shift_nama').textContent = shiftNama;
            document.getElementById("deleteForm").action = "/shift/" + id;
